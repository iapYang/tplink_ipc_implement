"""TP-Link IPC switch entity.

This module contains the TplinkIpcSwitch class which represents a TP-Link IPC switch entity.
"""
...
class TplinkIpcSwitch(SwitchEntity):
    ...
    def __init__(
        ...
        self._attr_unique_id = "{}.{}_{}".format(
            DOMAIN, "tplink_ipc_lens_mask", self._key
        ).lower()
    ...
    async def _update_is_on(self):
        ...
        data = await self._tplink_ipc_core.post_data(
